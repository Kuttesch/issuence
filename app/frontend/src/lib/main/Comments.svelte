...
<div class="w-full h-auto flex flex-col items-start justify-start">
    <div class="w-full h-auto flex items-center justify-start bg-background dark:bg-dark-background rounded-2xl p-2">
        ...
        <Button class="w-20 h-12 bg-primary dark:bg-dark-primary text-text dark:text-dark-text text-lg font-bold rounded-xl hover:scale-110 focus: ring-transparent" on:click={addComment} >Add</Button>
    </div>
</div>