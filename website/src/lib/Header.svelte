<script lang="ts">
    import { Button, P, DarkMode, Toggle } from "flowbite-svelte";
...
<div class="w-auto h-10 flex justify-start items-center fixed top-0 left-0 m-4 md:ml-8 ml-2 z-50">
    <img src={icon} alt="Icon" class="w-auto h-full m-2 drop-shadow-main-small dark:drop-shadow-dark-main-small" />
    <P class="md:text-2xl text-xl text-text dark:text-dark-text drop-shadow-main-small dark:drop-shadow-dark-main-small">Issuence</P>
</div>

<div class="w-auto h-10 fixed top-0 right-0 flex justify-start items-center m-4 md:mr-8 mr-2 z-50">
