...
<div class="w-auto h-10 flex justify-start items-center fixed top-0 left-0 m-4 ml-8">
    <img src={icon} alt="Icon" class="w-auto h-full m-2 drop-shadow-main-small dark:drop-shadow-dark-main-small" />
    <P class="text-3xl text-text dark:text-dark-text drop-shadow-main-small dark:drop-shadow-dark-main-small">Issuence</P>
</div>

<div class="w-auto h-10 fixed top-0 right-0 flex justify-start items-center m-4 mr-8">
    ...
    <Button      class="text-text dark:text-dark-text text-lg p-4 pt-2 pb-2 hover:scale-110 cursor-pointer focus:ring-0" on:click={() => openLink($downloadLink)}>Download</Button>
